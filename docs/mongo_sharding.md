...
MONGODB_CLUSTER_ADMIN_PASSWORD=$(kubectl get secrets --namespace <NAMESPACE> everest-secrets-<CLUSTER_NAME> -o go-template='{{`{{index .data "MONGODB_CLUSTER_ADMIN_PASSWORD" | base64decode}}`}}')
```
