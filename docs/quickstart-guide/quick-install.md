...
1. To install Percona Everest, run the following command:
    ...
    ```{.bash data-prompt="$"}
    $ curl -sfL "https://raw.githubusercontent.com/percona/percona-everest/v0.9.0/install.sh" | bash
    ```
    ...
    ??? example "Expected output"
        ...
        https://github.com/percona/percona-everest/releases/download/v0.9.0/everestctl-linux-amd64
