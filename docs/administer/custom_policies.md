...
4. Click **Delete**.
    ...
    !!! note
        If a policy is applied to any cluster, you must first [remove the policy](apply_policies_cluster.md#change-pod-scheduling-policy-for-an-existing-db-cluster) before you can delete it.
