...
!!! caution alert alert-warning "warning"
    To install a new version of Percona Everest, first [uninstall the old version](../release-notes/Percona Everest 0.8.0 (2024-02-22).md#breaking-changes-in-percona-everest-080) using the old CLI.
