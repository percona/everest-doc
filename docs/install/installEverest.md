...
!!! caution alert alert-warning "warning"
    To install a new version of Percona Everest, first [uninstall the old version](../release-notes/Percona%20Everest%200.8.0%20%282024-02-22%29.md#breaking-changes-in-percona-everest-080) using the old CLI binary.
