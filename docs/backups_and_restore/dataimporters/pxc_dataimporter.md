...
## How to import external MySQL backups using the OpenEverest UI
...
2. From the OpenEverest homepage, click **Import**. Select the database as **MySQL**. The **Basic Information** page will then be displayed.
