...
Here are the steps to import external database backups using Percona Everest UI with the `everest-percona-psmdb-operator` importer:
{.power-number}
...
## :simple-mongodb: Import MongoDB backups
