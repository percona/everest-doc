...
## How to import external MongoDB backups using the OpenEverest UI
...
2. From the OpenEverest homepage, click **Import**. Select the database type as MongoDB. The **Basic Information** page will be displayed.
