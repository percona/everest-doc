...
2. To update the database engine configuration for your existing database, go the Everest home page and select the database you want to update. The **Overview** page will then be displayed. 

3. Click **Edit**. The **Edit advanced configuration** screen will be displayed.

4. To enable external access beyond the Kubernetes cluster network, turn on the toggle.
...
10. If you are creating a new database cluster, click **Create database** and for existing database cluster click **Edit database**. The database engine parameters will be updated.
