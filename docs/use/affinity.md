...
|**Components**|<ul><li>Config Server</li><li>DB Node</li><li>Router</br></br></br></br></li><li>DB Node</br><br></li><li>DB Node</li><li>Proxy</li></ul>|Applicable for **MongoDB sharded cluster**.<br/></br></br></br>Applicable for **MongoDB non sharded cluster**.</br></br></br></br>Applicable for **MySQL** and **PostgreSQL** databases.|
