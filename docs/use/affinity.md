...
|**key**|The key field is a label that identifies resources like Pods or nodes through their associated labels.|Here are some examples of **key**:</br><ul><li> app</li><li>tier</li><li>environment</li><li>custom labels (e.g., security, web-store)</li></ul>|
