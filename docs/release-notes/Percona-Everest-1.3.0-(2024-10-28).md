...
??? info "Release summary at a glance"
    ...
    | **3.**  |[Database status](https://docs.percona.com/everest/release-notes/Percona-Everest-1.3.0-%282024-10-28%29.html#__tabbed_1_3)|Check your database status from the database details page|
